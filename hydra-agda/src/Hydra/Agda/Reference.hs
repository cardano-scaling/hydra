...
checkClose = M.d_closeRef'7495'_94

-- | Injected boundary for increment\/decrement.
type OpsInc = M.T_OpsInc_152

mkOpsInc :: (HsIncIO -> Bool) -> OpsInc
mkOpsInc = M.C_OpsInc'46'constructor_2845
...
checkDec = M.d_decRef'7495'_164

-- | Injected boundary for contest.
type OpsContest = M.T_OpsContest_218

mkOpsContest :: (HsContestIO -> Bool) -> OpsContest
mkOpsContest = M.C_OpsContest'46'constructor_3517
...
checkContest = M.d_contestRef'7495'_224

-- | Injected boundary for fanout\/finalPartialFanout.
type OpsFanout = M.T_OpsFanout_254

mkOpsFanout :: (HsFanout -> Bool) -> OpsFanout
mkOpsFanout = M.C_OpsFanout'46'constructor_3771
...
checkRecover = M.d_recoverRef'7495'_284
...
type OpsInit = M.T_OpsInit_302

mkOpsInit :: (HsMintIO -> Bool) -> OpsInit
mkOpsInit = M.C_OpsInit'46'constructor_3955
...
checkInit = M.d_initRef'7495'_308
...
type OpsClaim = M.T_OpsClaim_334

mkOpsClaim :: (HsClaimIO -> Bool) -> OpsClaim
mkOpsClaim = M.C_OpsClaim'46'constructor_4085
...
checkClaim = M.d_claimRef'7495'_340
