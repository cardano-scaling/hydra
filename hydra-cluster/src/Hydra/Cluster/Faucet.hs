  ...
  case buildTransactionWithPParams' pparams systemStart eraHistory stakePools (mkVkAddress networkId faucetVk) foundUTxO [] [theOutput] Nothing of
    ...
    Right tx -> do
      ...
      case eResult of
        ...
        Right _ -> do
          void $ Blockfrost.awaitUTxO networkId [changeAddress] (Hydra.Tx.txId signedTx) 200
          Blockfrost.awaitUTxO networkId [receivingAddress] (Hydra.Tx.txId signedTx) 200
 where
