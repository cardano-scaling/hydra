...
This deployment model has the undesirable property of requiring trust from clients to operators and custodianship of funds committed to the Head. In effect, it's a way to create a _Side-chain_ with the _Operators_ being responsible for its safety and liveness.
