...
An example use case for two-party Hydra Heads are plain old payment channels between two [machines](../../use-cases/payments/pay-per-use-api) or [individuals](../../use-cases/payments/inter-wallet-payments) (especially if multiple such channels are logically connected like in the Lighning network).
