...
- [hydra-tui](./getting-started.md#use-the-head): Example client offering a terminal user interface (TUI) that can be used to administrate heads and submit simple payment transactions
