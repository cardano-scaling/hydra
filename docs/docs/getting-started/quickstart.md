...
* A Terraform based configuration to deploy a single Hydra node + Testnet Cardano node on [Google Cloud](https://github.com/input-output-hk/hydra-poc/tree/master/sample-node-config/gcp/)
