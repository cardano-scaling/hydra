...
Every couple of months, the team reflects on the the themes identified for 2023 (as
presented in [January](/monthly/2023-01#themes-for-2023)), and creates a very high
...
- Sustainable open-source :green_heart:
  ...
  - **Engage and support developer community on catalyst proposals**: There are
    ...
    proposals. The goal here is to provide a platform for the many new ideas out
    there, while avoiding fragmentation and maximizing reuse of work.
...
- Mainnet mature application :purple_heart:
  ...
  - **Make Hydra trivial to use**: Improving user and developer experience,
    ...
    Mithril to get started. The goal is to be able to open a distributed hydra head
  ...
  - **Build a basic head explorer**: In the past we experimented with an
    explorer already, but this time we want to set it up for the long term. Not only
...
- Drive adoption :blue_heart:
  ...
  - **Deliver a first version of HydraNow to mainnet**: 
...
Work packages related to these items pop up on the technical
...
communicate with their peers, this introduced an additional unneeded
...
There was a bug in the multisignature verification which could compromise
...
Not many questions on our journey to mature the Hydra software stack further to
support various use cases building on it. However, the recently kicked-off
Fund10 of catalyst sparked a nice discussion of how to handle all these great new
ideas while being conscious of not fragmenting the scaling efforts too much.

Open protocols mean that new ideas can be incorporated not only in the various
