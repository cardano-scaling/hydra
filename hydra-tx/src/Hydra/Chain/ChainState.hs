...
class
  ...
  -- | Get the chain time from a chain point.
  chainPointTime :: ChainPointType tx -> UTCTime
...
chainStateTime = chainPointTime . chainStatePoint
chainStateTime :: IsChainState tx => ChainStateType tx -> UTCTime
-- REVIEW!
