...
import Test.QuickCheck (listOf, listOf1, oneof, scale, shrinkList, shrinkMapBy, sized, suchThat, vector, vectorOf, Property, choose, counterexample, frequency, property)
...
deriving instance Arbitrary SnapshotNumber
deriving instance Arbitrary SnapshotVersion
deriving instance Arbitrary ChainSlot
