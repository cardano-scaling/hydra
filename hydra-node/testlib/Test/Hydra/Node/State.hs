...
import Hydra.Node.State (ChainPointTime, Deposit, DepositStatus, NodeState, SyncedStatus, TrackedDeposit)
...
instance ArbitraryIsTx tx => Arbitrary (TrackedDeposit tx) where
  arbitrary = genericArbitrary
