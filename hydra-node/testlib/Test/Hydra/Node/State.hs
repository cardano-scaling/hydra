...
import Hydra.Node.State (ChainPointTime, Deposit, DepositHistory, DepositStatus, NodeState, SyncedStatus)
...
instance ArbitraryIsTx tx => Arbitrary (DepositHistory tx) where
  arbitrary = genericArbitrary
