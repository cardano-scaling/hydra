-- | A sqllite-based event source and sink using JSON encoding.
--
-- This serves as an example of how to create an 'EventSource' and 'EventSink'.
module Hydra.Events.SqlLiteBased where
...
-- | A basic sqllite based event source and sink defined using an
