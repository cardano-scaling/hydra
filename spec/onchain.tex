...
\begin{menumerate}
	...
	\]
	\red{where snapshot version and number are initialized as $v = s = 0$.}
...
\begin{menumerate}
	...
	\[
		(\stOpen,\cid,\hydraKeys,\cPer,\red{v,s,}\eta) \xrightarrow[\red{\mathsf{CloseType}}]{\stClose} (\stClosed,\cid,\hydraKeys,\cPer,\red{v',s',\eta',\eta_{\Delta}'},\contesters,\Tfinal)
	\]
...
\begin{menumerate}
	...
	\[
		(\stClosed,\cid,\hydraKeys,\cPer,\eta,\red{\eta_{\Delta}},\contesters,\Tfinal) \xrightarrow[m,n]{\stFanout} \stFinal
	\]
