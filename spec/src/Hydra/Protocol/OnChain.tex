...
\begin{menumerate}
	...
	therefore shared by every deposit input, so two deposits recording the same
	$C$ would both be satisfied by a single set of recovered outputs, leaving the
	second deposit's value to be directed anywhere by the transaction author:
	\[
