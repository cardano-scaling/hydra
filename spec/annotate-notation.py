...
DEFS = {
    ...
    "\U0001D705": (  # 𝜅 kappa
        "κ# — hash of the snapshot's commit output set and the claimed "
        "deposit's transaction id (commitOutputsHash). Bound into the signed "
        "message; increment recomputes it on-chain from the claimed deposit's "
        "datum and reference."
    ),
    "₳": (
